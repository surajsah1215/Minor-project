...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(Main.communal,"Communal Tweets","Communal Tweets");
	localDefaultCategoryDataset.addValue(Main.non,"Noncommunal Tweets","Noncommunal Tweets");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Tweets Type", "Count", paramCategoryDataset,
